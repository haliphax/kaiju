$(function()
{
	$('#clan_opts_form').submit(function()
	{
		$.ajax({
			type: 'POST',
			url: kaiju_globals.site_url + 'clans/options/',
	...
	$('#clan_stepdown_form').submit(function()
	{
		...
		$.ajax({
			type: 'POST',
			url: kaiju_globals.site_url + 'clans/stepdown/',
	...
	$('#send_invitation').submit(function()
	{
		$.ajax({
			type: 'POST',
			url: kaiju_globals.site_url + 'clans/send_invitation/',
			data: {
...
function list_applications()
{
	$.ajax({
		type: 'GET',
		url: kaiju_globals.site_url + 'clans/list_applications/',
		dataType: 'html',
		success: function(ret)
		{
...
function list_invitations()
{
	$.ajax({
		type: 'GET',
		url: kaiju_globals.site_url + 'clans/list_invitations/',
		dataType: 'html',
		success: function(ret)
		{
...
function cancel_invitation(who)
{
	$.ajax({
		type: 'GET',
		url: kaiju_globals.site_url + 'clans/cancel_invitation/' + who + '/',
		dataType: 'json',
		success: function(ret)
		{
			if(ret == null || ! ret.success)
...
function accept_application(who)
{
	$.ajax({
		type: 'GET',
		url: kaiju_globals.site_url + 'clans/accept_application/' + who + '/',
		dataType: 'json',
		success: function(ret)
		{
			if(ret == null || ! ret.success)
...
function deny_application(who)
{
	$.ajax({
		type: 'GET',
		url: kaiju_globals.site_url + 'clans/deny_application/' + who + '/',
		dataType: 'json',
		success: function(ret)
		{
			if(ret == null || ! ret.success)
...
function remove_member(who)
{
	...
	$.ajax({
		type: 'GET',
		url: kaiju_globals.site_url + 'clans/remove_member/' + who + '/',
		dataType: 'json',
		success: function(ret)
		{
			if(ret == null || ! ret.success)
...
function remove_relation(which)
{
	...
	$.ajax({
		type: 'GET',
		url: kaiju_globals.site_url + 'clans/remove_relation/' + which + '/',
		dataType: 'json',
		success: function(ret)
		{
			if(ret == null || ! ret.success)
