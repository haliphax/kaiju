$(function()
{
	...
	$.ajax({
		type: 'GET',
		url: kaiju_globals.site_url + 'clans/list_open/',
		dataType: 'html',
	...
	$('#clan_application').submit(function()
	{
		$.ajax({
			type: 'POST',
			url: kaiju_globals.site_url + 'clans/apply/',
			data: {
	...
	$('#closed_clans_tab').bind('click', function()
	{
		...
		$.ajax({
			type: 'GET',
			url: kaiju_globals.site_url + 'clans/list_closed/',
			dataType: 'html',
			success: function(ret)
			{
...
function accept_invitation(clan)
{
	$.ajax({
		type: 'GET',
		dataType: 'json',
		url: kaiju_globals.site_url + 'clans/accept_invitation/' + clan + '/',
		success: function(ret)
		{
			if(ret == null || ! ret.success)
...
function deny_invitation(clan)
{
	$.ajax({
		type: 'GET',
		dataType: 'json',
		url: kaiju_globals.site_url + 'clans/deny_invitation/' + clan + '/',
		success: function(ret)
		{
			if(ret == null || ! ret.success)
